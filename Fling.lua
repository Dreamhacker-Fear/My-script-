...
--// Patched: avatar → REAPEROFCHRISTUS (8407673016), GUI centered, scrollable, clamp fix
...
-- ✅ FIX: Scrolling container that holds all the buttons
...
-- Top UI elements (stay fixed at top, not in scroll)
